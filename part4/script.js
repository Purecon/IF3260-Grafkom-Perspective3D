...
function main() {
  ...
  // Setup a ui.
  setupSlider("#fieldOfView", {value: radToDeg(fieldOfViewRadians), slide: updateFieldOfView, min: 1, max: 179});
  setupSlider("#x", {value: translation[0], slide: updatePosition(0), min: -200, max: 200 });
  setupSlider("#y", {value: translation[1], slide: updatePosition(1), min: -200, max: 200});
  setupSlider("#z", {value: translation[2], slide: updatePosition(2), min: -1000, max: 0});
